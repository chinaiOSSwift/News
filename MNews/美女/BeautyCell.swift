...
class BeautyCell: BaseCollectionViewCell {
    ...
    /*
     ...
     //MARK: - 网络加载
     func loadData() -> Void{
     let preArg = "channelId=5572a10ab3cdc86cf39001f0&page="
     ...
     print("美女 数组:\(self.dataArr.count)")
     ...
     extension BeautyCell: UITableViewDelegate, UITableViewDataSource{

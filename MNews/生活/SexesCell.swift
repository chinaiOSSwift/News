...
class SexesCell: BaseCollectionViewCell {
    ...
    //MARK: - 网络加载
    func loadData() -> Void{
        let preArg = "channelId=5572a10ab3cdc86cf39001f2&page="
...
extension SexesCell: UITableViewDelegate, UITableViewDataSource{

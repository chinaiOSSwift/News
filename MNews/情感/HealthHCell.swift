...
class HealthHCell: BaseCollectionViewCell {
    ...
    //MARK: - 网络加载
    func loadData() -> Void{
        let preArg = "channelId=5572a10ab3cdc86cf39001f3&page="
...
extension HealthHCell: UITableViewDelegate, UITableViewDataSource{

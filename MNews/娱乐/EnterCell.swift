...
class EnterCell: BaseCollectionViewCell {
...
/*
    ...
    //MARK: - 网络加载
    func loadData() -> Void{
        let preArg = "channelId=5572a10ab3cdc86cf39001eb&page="
        ...
        BaseModel.requestBaseDtat(HOME_URL: HOME_URL, httpArg: httpArg) { (array, error) in
            if error == nil{
                ...
                print("娱乐最新数据 :\(self.dataArr.count)")
...
extension EnterCell: UITableViewDelegate, UITableViewDataSource{
